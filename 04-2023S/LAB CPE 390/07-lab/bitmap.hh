...
class bitmap {
 private:
  ...
  void plotLineLow(uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1,
                   uint32_t color);
  void plotLineHigh(uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1,
                    uint32_t color);
 ...
 public:
  ...
  void point(uint32_t x, uint32_t y, uint32_t color) { rgb[y * w + x] = color; }
  ...
  void grid(uint32_t x0, uint32_t y0, uint32_t w, uint32_t h, uint32_t divx,
            uint32_t divy, uint32_t color);
